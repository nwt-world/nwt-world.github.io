...
- a **short, controlled stay in Manila**,
- iconic volcano landscapes,
- overland travel where practical, flights where necessary.

Total duration: **8–12 days**, depending on pace.
...
- **Buses** are the main overland transport option on Luzon
- **Flights save enormous time** for long distances (e.g., Manila ↔ Legazpi)
- Expect slow travel even for moderate distances
...
- Travelers interested in **volcano landscapes**
- Visitors who want culture without long city stays
- Those comfortable with buses and domestic flights
- People looking for dramatic scenery rather than beaches

Luzon offers some of the **most striking volcanic scenery in Southeast Asia**,
best experienced with a focused and realistic plan.
