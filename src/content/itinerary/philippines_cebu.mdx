...
`
    ...
    {
      title: 'Cebu Island – Moalboal & Oslob',
      content: `
...
Important notes:
• Whale shark tourism in Oslob is controversial due to feeding practices
• Decide consciously whether to participate
...
Ferries are frequent, reasonably priced, and comfortable when using reputable operators.
`
    },
    {
...
- Travelers looking for **easy island hopping**
- Snorkeling and marine life enthusiasts
- First-time visitors to the Philippines
- Those who want variety without complex logistics

Cebu and nearby islands offer one of the **best introductions to the Philippines**:
accessible, diverse, and rich in both nature and culture.
